"""
This script convert a meebit in vox format to select GLB format.

It uses code from the following repo under gpl 3.0 license.
https://github.com/technistguru/MagicaVoxel_Importer

Usage:
blender MeebitRig.blend --background --python meebit_export_to_glb.py -- --meebit E:\meebits\13396\meebit_13396_t_solid.vox
"""
